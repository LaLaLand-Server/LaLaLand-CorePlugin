...
import de.lalaland.core.modules.mobs.custommobs.BiPipedFactory;
 ...
 *
 */
public class BiTestFactory implements BiPipedFactory<CustomTestZombie> {

  @Override
  public CustomTestZombie spawn(final Location location, final MobModelManager mobModelManager) {
    ...
    final CustomTestZombie mob = new CustomTestZombie(world.getMinecraftWorld(), mobModelManager, ((CraftArmorStand) as).getHandle());
    world.addEntity(mob);
