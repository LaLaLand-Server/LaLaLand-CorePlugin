...
public enum Model {
  ...
  PHYSICAL_ARMOR_ICON(Material.STICK, 10015, ModelData.common(), FontMeta.common(), new BoxedFontChar(), false, false),
  PHYSICAL_DAMAGE_ICON(Material.STICK, 10016, ModelData.common(), FontMeta.common(), new BoxedFontChar(), false, false),
  ...
  COINPILE_TINY(Material.STICK, 1019, ModelData.common(), FontMeta.common(), new BoxedFontChar(), false, true),
  COINPILE_SMALL(Material.STICK, 1020, ModelData.common(), FontMeta.common(), new BoxedFontChar(), false, true),
  COINPILE_MEDIUM(Material.STICK, 1021, ModelData.common(), FontMeta.common(), new BoxedFontChar(), false, true),
  COINPILE_BIG(Material.STICK, 1022, ModelData.common(), FontMeta.common(), new BoxedFontChar(), false, true),
  COINPILE_HUGE(Material.STICK, 1023, ModelData.common(), FontMeta.common(), new BoxedFontChar(), false, true),
  COINPILE_BAR_SMALL(Material.STICK, 1024, ModelData.common(), FontMeta.common(), new BoxedFontChar(), false, true),
  COINPILE_BAR_MEDIUM(Material.STICK, 1025, ModelData.common(), FontMeta.common(), new BoxedFontChar(), false, true),
  COINPILE_BAR_BIG(Material.STICK, 1026, ModelData.common(), FontMeta.common(), new BoxedFontChar(), false, true),
  JOB_ICON_WOODCUTTER(Material.STICK, 1027, ModelData.common(), FontMeta.common(), new BoxedFontChar(), false, false),
  JOB_ICON_MINING(Material.STICK, 1028, ModelData.common(), FontMeta.common(), new BoxedFontChar(), false, false),
  JOB_ICON_FISHING(Material.STICK, 1029, ModelData.common(), FontMeta.common(), new BoxedFontChar(), false, false),
  JOB_ICON_HERBLORE(Material.STICK, 1030, ModelData.common(), FontMeta.common(), new BoxedFontChar(), false, false),
  JOB_ICON_BREWING(Material.STICK, 1031, ModelData.common(), FontMeta.common(), new BoxedFontChar(), false, false),
  JOB_ICON_CONSTRUCTION(Material.STICK, 1032, ModelData.common(), FontMeta.common(), new BoxedFontChar(), false, false),
  JOB_ICON_COOKING(Material.STICK, 1033, ModelData.common(), FontMeta.common(), new BoxedFontChar(), false, false),
  JOB_ICON_CRAFTING(Material.STICK, 1034, ModelData.common(), FontMeta.common(), new BoxedFontChar(), false, false),
  JOB_ICON_JEWEL_CRAFTING(Material.STICK, 1035, ModelData.common(), FontMeta.common(), new BoxedFontChar(), false, false),
  JOB_ICON_SMITHING(Material.STICK, 1036, ModelData.common(), FontMeta.common(), new BoxedFontChar(), false, false),
