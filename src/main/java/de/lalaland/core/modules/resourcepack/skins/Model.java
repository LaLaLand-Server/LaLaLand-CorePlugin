...
public enum Model {
  ...
  SERVER_ICON(Material.STICK, 2021, ModelData.common(), FontMeta.of(32, 32, "bitmap"), new BoxedFontChar(), false),
  AC_SEMIDIRT(Material.STICK, 2022, ModelData.common(), FontMeta.common(), new BoxedFontChar(), true);
