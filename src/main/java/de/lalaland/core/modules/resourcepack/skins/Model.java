...
public enum Model {
  ...
  T1_ARM_RIGHT(Material.STICK, 1027, ModelData.common(), FontMeta.common(), new BoxedFontChar(), false, true),
  T1_ARM_LEFT(Material.STICK, 1028, ModelData.common(), FontMeta.common(), new BoxedFontChar(), false, true),
  T1_HEAD(Material.STICK, 1029, ModelData.common(), FontMeta.common(), new BoxedFontChar(), false, true),
  T1_BODY(Material.STICK, 1030, ModelData.common(), FontMeta.common(), new BoxedFontChar(), false, true),
