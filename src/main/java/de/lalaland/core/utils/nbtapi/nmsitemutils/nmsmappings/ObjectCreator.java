...
public enum ObjectCreator {
  ...
  NMS_BLOCKPOSITION(null, null, ClassWrapper.NMS_BLOCKPOSITION.getClazz(), int.class, int.class,
      int.class),
  ...
  ObjectCreator(MinecraftVersion from, MinecraftVersion to, Class<?> clazz, Class<?>... args) {
    ...
    try {
      ...
      System.out.println("�cUnable to find the constructor for the class '" + clazz.getName());
      ex.printStackTrace();
    }
  }
  ...
  public Object getInstance(Object... args) {
    try {
      ...
      throw new NbtApiException("Exception while creating a new instance of '" + targetClass + "'",
          ex);
    }
  }
